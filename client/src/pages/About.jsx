    ...
    <div className="min-h-screen bg-gray-50 animate-fade-in pb-20">
      ...
      <div className="p-6 md:max-w-2xl md:mx-auto">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm text-center mb-6 border border-gray-100">
          ...
          <h2 className="text-2xl font-bold text-blue-900 mb-1">BinaKarier</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              BinaKarier adalah platform nirlaba yang didedikasikan untuk mendemokratisasi akses pengembangan diri. Kami menghubungkan mentor profesional dengan generasi muda Indonesia melalui webinar dan bootcamp gratis berkualitas.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
              <a href="#" className="flex items-center gap-3 text-gray-600 p-3 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-200">
                ...
                <span className="text-sm font-medium">hello@binakarier.id</span>
              </a>
              <a href="#" className="flex items-center gap-3 text-gray-600 p-3 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-200">
                <Globe size={18} className="text-blue-500" />
                <span className="text-sm font-medium">www.binakarier.id</span>
              </a>
              <a href="#" className="flex items-center gap-3 text-gray-600 p-3 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-200">
                <Github size={18} className="text-blue-500" />
                <span className="text-sm font-medium">github.com/binakarier</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center text-gray-400 text-xs">
          &copy; 2025 BinaKarier Foundation. Hak Cipta Dilindungi.
        </div>
      </div>
    </div>
  );
